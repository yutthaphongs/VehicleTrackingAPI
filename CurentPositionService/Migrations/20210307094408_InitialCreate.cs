    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CurentPositionId = table.Column<int>(type: "int", nullable: false)
                    ...
                    CurentDate = table.Column<DateTime>(type: "datetime", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurentPositions", x => x.CurentPositionId);
                });
        }
